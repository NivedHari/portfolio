...
export default function Skills() {
  return (
    <div className="text-white text-center mt-20 text-3xl md:text-5xl max-w-6xl mx-auto w-full min-h-screen">
      <h1 className="mb-20 font-bold text-5xl md:text-6xl bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 text-transparent bg-clip-text inline">My Skills</h1>
